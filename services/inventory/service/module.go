...
var Module = fx.Module("service",
	...
	fx.Provide(func(db *gorm.DB, txManager transaction.Manager, catalog cataloguc.Usecase, warehouse warehouseuc.Usecase, movement movementuc.Usecase) Service {
		return NewInventoryService(db, txManager, catalog, warehouse, movement)
	}),
)
