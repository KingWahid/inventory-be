...
// Config drives the Redis Streams consumer for ARCHITECTURE §10 consumer group "alerts".
type Config struct {
...
// Run blocks until ctx done: ensures consumer group, reads via XREADGROUP, verifies HMAC, dispatches StockBelowThreshold (stub) and ACKs on success.
